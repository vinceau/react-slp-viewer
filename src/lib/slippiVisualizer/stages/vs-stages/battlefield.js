...
export default {
    ...
    ceiling: [
        [new Vec2D(-65, -6), new Vec2D(-36, -19)],
        [new Vec2D(-29, -35), new Vec2D(-10, -40)],
        [new Vec2D(-10, -30), new Vec2D(10, -30)],
        [new Vec2D(65, -6), new Vec2D(36, -19)],
        [new Vec2D(29, -35), new Vec2D(10, -40)]
    ],
    wallL: [
        [new Vec2D(-68.4, 0), new Vec2D(-65, -6)],
        [new Vec2D(-36, -19), new Vec2D(-39, -21)],
        [new Vec2D(-39, -21), new Vec2D(-33, -25)],
        [new Vec2D(-33, -25), new Vec2D(-30, -29)],
        [new Vec2D(-30, -29), new Vec2D(-29, -35)],
        [new Vec2D(10, -30), new Vec2D(10, -40)]
    ],
    wallR: [
        [new Vec2D(68.4, 0), new Vec2D(65, -6)],
        [new Vec2D(36, -19), new Vec2D(39, -21)],
